...
# Italian 3rd
ground_236 = Ground('AlbinoLeffe Stadium', 'U.C. AlbinoLeffe', 'Zanica', league_12, 1791, False)
ground_repository.save(ground_236)
ground_237 = Ground('Tommaso Dal Molin Stadium', "F.C. Arzignano Valchiampo", 'Arzignano', league_12, 2000, False)
ground_repository.save(ground_237)
ground_238 = Ground('Stadio Lino Turina', 'Feralpisalò', 'Salò', league_12, 2364, False)
ground_repository.save(ground_238)
ground_239 = Ground('Stadio Giuseppe Moccagatta', 'Juventus Next Gen', 'Alessandria', league_12, 5827, False)
ground_repository.save(ground_239)
ground_240 = Ground('Stadio Rigamonti-Ceppi', 'Calcio Lecco 1912', 'Lecco', league_12, 4997, False)
ground_repository.save(ground_240)
ground_241 = Ground('Stadio Danilo Martelli', 'Mantova 1911', 'Mantua', league_12, 14884, False)
ground_repository.save(ground_241)
ground_242 = Ground("Stadio Silvio Piola", 'Novara F.C.', 'Novara', league_12, 17875, False)
ground_repository.save(ground_242)
ground_243 = Ground("Stadio Euganeo", 'Calcio Padova', 'Padua', league_12, 32420, False)
ground_repository.save(ground_243)
ground_244 = Ground('Stadio Giuseppe Voltini', 'U.S. Pergolettese 1932', 'Crema', league_12, 4095, False)
ground_repository.save(ground_244)
ground_245 = Ground('Stadio Leonardo Garilli', "Piacenza Calcio 1919", 'Piacenza', league_12, 21668, False)
ground_repository.save(ground_245)
ground_246 = Ground('Stadio Guido Teghil', 'Pordenone Calcio', 'Pordenone', league_12, 5000, False)
ground_repository.save(ground_246)
ground_247 = Ground("Stadio Carlo Speroni", 'Aurora Pro Patria 1919', 'Busto Arsizio', league_12, 4627, False)
ground_repository.save(ground_247)
ground_248 = Ground("Stadio Breda", 'Pro Sesto 1913 / F.C. Sangiuliano City', 'Sesto San Giovanni', league_12, 4500, False)
ground_repository.save(ground_248)
ground_249 = Ground("	Stadio Silvio Piola", 'F.C. Pro Vercelli 1892', 'Vercelli', league_12, 5500, False)
ground_repository.save(ground_249)
ground_250 = Ground('Stadio Città di Meda', 'A.C. Renate', 'Meda', league_12, 3000, False)
ground_repository.save(ground_250)
ground_251 = Ground('Stadio Briamasco', 'A.C. Trento 1921', 'Trento', league_12, 4227, False)
ground_repository.save(ground_251)
ground_252 = Ground('Stadio Nereo Rocco', 'U.S. Triestina Calcio 1918', 'Triestina', league_12, 24500, False)
ground_repository.save(ground_252)
ground_253 = Ground('Stadio Romeo Menti', 'L.R. Vicenza', 'Vicenza', league_12, 12000, False)
ground_repository.save(ground_253)
ground_254 = Ground('Stadio Gavagnin Nocini', 'Virtus Verona', 'Verona', league_12, 1200, False)
